...
"""
timestamp(g::SnowflakeIdGenerator, id::Int64) = id >>> g.node_id_and_sequence_bits
...
"""
node_id(g::SnowflakeIdGenerator, id::Int64) = (id >>> g.sequence_bits) & g.max_node_id
...
"""
sequence(g::SnowflakeIdGenerator, id::Int64) = id & g.max_sequence
