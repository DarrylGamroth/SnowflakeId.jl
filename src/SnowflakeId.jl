...
export SnowflakeIdGenerator, node_id, timestamp_offset_ms, max_node_id, max_sequence, next_id, extract_timestamp, extract_node_id, extract_sequence
...
const MAX_NODE_ID_AND_SEQUENCE_BITS = 22
...
"""
mutable struct SnowflakeIdGenerator
